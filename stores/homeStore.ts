...
const initialCategories: Category[] = [
  ...
  // { title: "热门剧集", type: "tv", tag: "热门" },
  {
    ...
    tags: [
        "热门",
        "最新", "悬疑", "犯罪", "奇幻", "惊悚", "都市", "搞笑", "古装", "爱情", // bd opendata 分类
  ...
  // { title: "豆瓣 Top250", type: "movie", tag: "top250" },
  {
    title: "综艺",
    type: "show",
    tags: ["全部", "最新", "游戏", "竞技", "音乐", "励志", "搞笑", "喜剧", "运动", "社会", "益智", "生活", "犯罪",],
  },
  {
    title: "动漫",
    type: "anime",
    tags: ["全部", "最新", "卡通", "动漫", "奇幻", "热血", "玄幻", "探险", "漫画", "战斗", "小说", "穿越", "魔幻",],
  },
  {
    title: "纪录片",
    type: "docu",
    tags: ["全部", "最新", "美剧", "历史", "社会", "自然", "人文", "文化", "人物", "纪实", "美食", "探索", "传记",],
  },
];
